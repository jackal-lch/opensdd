...
- If user has no blueprint: "I recommend running /create-blueprint first to create one. Would you like to proceed anyway with what you know about the product?"
</prerequisite>
