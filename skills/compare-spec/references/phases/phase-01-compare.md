...
Invoke `compare-spec-agent` to perform complete bidirectional comparison.

<subagent agent="compare-spec-agent">
  <input>
    <param name="spec_file">.opensdd/spec.yaml</param>
    <param name="extracted_dir">.opensdd/extracted/</param>
  </input>
</subagent>
...
Take the JSON result from compare-spec-agent and write as YAML.
